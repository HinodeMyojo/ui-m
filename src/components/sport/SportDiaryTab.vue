...
/* Квадрат — пока колонка узкая. На широком экране квадратная клетка вырастает
   до плитки в сотню пикселей, поэтому высоту ограничиваем: содержимое клетки
   (число, точки, вес) занимает ровно эти три строки. */
.sp-cal-cell {
  aspect-ratio: 1;
  max-height: 64px;
